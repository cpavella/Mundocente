        ...
        <div class="ui piled very padded left aligned segment">
            <form class="ui form" id="form">
                ...
                <div class="field">
                    ...
                    <div class="ui blue button">Cargar</div>
                </div>
                <div class="two fields">
                    <div class="required field">
                        <label>Enlace de currículo en la web</label>
                        <input name="link" type="text">
                    </div>
                    <div class="required field">
                        <label>Cargar currículo</label>
                    </div>
                </div>
                <div class="required field">
                    <label>Nombre</label>
                    <div class="equal width fields">
                        <div class="field">
                            <input name="name" type="text" placeholder="Nombre" value="{{Auth::user()->name}}">
                        </div>
                        <div class="field">
                ...
                <div class="equal width fields">
                    <div class="required field">
                        <label>Intitución para la que labora</label>
                        <select name="city" class="ui search dropdown">
                            <option value="">Seleccionar una institución</option>
                            <option value="city_1">Afghanistan</option>
                            <option value="city_2">Åland Islands</option>
                            <option value="city_3">Albania</option>
                        </select>
                ...
                <div class="equal width fields">
                    <div class="field">
                        ...
                        <input type="email" name="e-mail" value="{{Auth::user()->email}}">
                    </div>
                    <div class="field">
                        <div class="field">
                ...
                <h4 class="ui dividing header">Notificaciones</h4>
