...
<div class="pusher" style="background-color: #EEEEEE;">
    <div class="ui container center aligned">
        <h1 class="ui center aligned header">Publicar Invitación</h1>
        <div>
            <div class="line"></div>
        ...
        <div class="ui piled very padded left aligned segment">
            <form class="ui form" id="form">
                ...
                <div class="required grouped fields">
                    ...
                    <div class="field">
                        <div class="ui radio checkbox">
                            <input type="radio" name="invitation">
                ...
                fields: {
                    invitation: {
                        ...
                        rules: [
                            {
                                type   : 'checked',
                                prompt : 'Porfavor seleccione un Tipo de invitación'
                            }
                        ]
                    },
                    large_area: {
