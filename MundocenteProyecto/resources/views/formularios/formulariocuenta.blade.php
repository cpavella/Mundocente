...
@section('content')
                ...
                <form class="ui form" id="form">
                    ...
                    <div class="equal width fields">
                        <div class="field">
                            ...
                            <img class="ui bottom aligned rounded image" src="../images/public-image.png" style="width: 180px;">
                            <span>
                    ...
                    <div class="required field">
                        ...
                        <div class="ui info compact small message" style="margin-top: 0; margin-bottom: 5px;">
                            <ul class="list">
                                <li>Debe ingresar al menos uno de los dos campos correspondientes a currículo.</li>
                            </ul>
                        </div>
                        <div class="two fields">
                            ...
                            <div class="required field">
                                <div class="ui action input">
                                    <input type="text" name="load_curriculum" id="_attachmentName" placeholder="Archivo currículo">
                    ...
                    <div class="required field">
                        <label>Logros universitarios</label>
                    ...
                    <div class="required field">
                        <label>Términos y condiciones <a class="ui teal label">Leer términos y condiciones</a></label>
                        <div class="inline field">
                            <div class="ui checkbox">
                                <input type="radio" tabindex="0" class="hidden" name="terms_conditions">
    ...
    <script type="text/javascript">
        ...
        function validateFormAccount() {
            ...
            if(allFields.notification == false){
                                ...
                                fields: {
                                    ...
                                    country: {
                                        ...
                                        rules: [
                                            {
                                                type: 'empty',
                                                prompt: 'Porfavor introduzca un valor en País'
                                            }
                                        ]
                                    },
                                    city: {
                                        ...
                                        rules: [
                                            {
                                                type: 'empty',
                                                prompt: 'Porfavor introduzca un valor en Ciudad'
                                            }
                                        ]
                                    },
                                    institution: {
                                    ...
                                    terms_conditions: {
                                        ...
                                        rules: [
                                            {
                                                type: 'checked',
                                                prompt: 'Debe aceptar los términos y condiciones para poder hacer uso de Mundocente'
                                            }
                                        ]
                                    }
                                }
